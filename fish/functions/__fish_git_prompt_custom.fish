...
function __fish_git_prompt_custom --description "Prompt function for Git"
    ...
    set -l last_git_update "|⇅ "(__last_git_update)

    printf "%s$format%s" "$___fish_git_prompt_color_prefix" "$___fish_git_prompt_color_prefix_done$c$b$f$r$p$informative_status$last_git_update$___fish_git_prompt_color_suffix" "$___fish_git_prompt_color_suffix_done"
